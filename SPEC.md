...
- 나이트 근무 후 **2일 이상 연속 휴식** 필수 (🚧 검증만 구현, 생성 로직은 미구현)
- ~~**2주 연속 나이트 근무 금지**~~ (규칙 재확인 중 - 일시적으로 제거됨)
...
1. **나이트 후 2일 휴식 규칙** 🚧
   - 나이트 후 2일 이상 연속 휴식 강제 배정
   - (현재는 검증만 있고 자동 배정 로직 없음)
   - ~~2주 연속 나이트 금지~~ (규칙 재확인 중 - 일시적으로 제거됨)
